...
switch($encoder) {
    ...
    # Debug Vars
        ...
        $vmode = 13 ;
        $amode = 0;
        $cmd = "bmdcapture -m ". $mode ." -V " . $vmode . " -A ". $amode ." -F nut -f pipe:1 | avconv -re -i - -c:v libx264 -profile:v baseline -preset medium -level 30 -aspect 16:9 -s 1280x720 -b:v 200k -r 25 -g 48 -keyint_min 48 -sc_threshold 0 -c:a libvo_aacenc -ab 32k -ar 48000 -ac 2 -tune zerolatency -f flv rtmp://" . $hostname . ":1935/myapp/stream >/dev/null 2>/dev/null & echo $!";
